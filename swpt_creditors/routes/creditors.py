...
class CreditorEndpoint(MethodView):
    ...
    @creditors_api.doc(operationId='getCreditor', security=specs.SCOPE_ACCESS)
...
class WalletEndpoint(MethodView):
    ...
    @creditors_api.doc(operationId='getWallet', security=specs.SCOPE_ACCESS)
    def get(self, creditorId):
...
class PinInfoEndpoint(MethodView):
    ...
    @creditors_api.doc(operationId='getPinInfo', security=specs.SCOPE_ACCESS)
    def get(self, creditorId):
...
class LogEntriesEndpoint(MethodView):
    ...
    @creditors_api.doc(operationId='getLogPage', security=specs.SCOPE_ACCESS)
...
class AccountsListEndpoint(MethodView):
    ...
    @creditors_api.doc(operationId='getAccountsList', security=specs.SCOPE_ACCESS)
    def get(self, creditorId):
...
class TransfersListEndpoint(MethodView):
    ...
    @creditors_api.doc(operationId='getTransfersList', security=specs.SCOPE_ACCESS)
    def get(self, creditorId):
