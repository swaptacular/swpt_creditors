...
class Configuration(metaclass=MetaEnvReader):
    ...
    OPENAPI_REDOC_URL = (
        ...
        "swpt_creditors/redoc.standalone.js"
    )
    ...
    APP_FLUSH_UPDATED_LEDGER_BURST_COUNT = 5000
    APP_FLUSH_UPDATED_POLICY_BURST_COUNT = 5000
    APP_FLUSH_UPDATED_FLAGS_BURST_COUNT = 5000
