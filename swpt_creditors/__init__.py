...
class Configuration(metaclass=MetaEnvReader):
    ...
    APP_PROCESS_LOG_ADDITIONS_WAIT = 4.0
    APP_PROCESS_LOG_ADDITIONS_MAX_COUNT = 120000
    APP_PROCESS_LEDGER_UPDATES_BURST = 1000
    APP_PROCESS_LEDGER_UPDATES_MAX_COUNT = 120000
    APP_PROCESS_LEDGER_UPDATES_WAIT = 4.0
