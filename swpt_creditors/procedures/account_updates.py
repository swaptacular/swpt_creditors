...
def process_account_update_signal(
    ...
    if data is None:
        ...
        #       would be safer, but would allow not fully trusted
        #       parties (account servers) to create local accounts at
        #       will. Consider using a configuration flag, controlling
        #       this behavior.
