...
Revision ID: 13d86172c5a2
Revises: 8d8c816257ce
Create Date: 2020-07-26 18:34:24.185668
...
def upgrade():
    ...
    op.create_index('idx_ledger_entry_entry_id', 'ledger_entry', ['creditor_id', 'debtor_id', 'entry_id', 'creation_date', 'transfer_number', 'aquired_amount', 'principal', 'added_at_ts', 'previous_entry_id'], unique=False)
    op.create_index('idx_ledger_entry_transfer', 'ledger_entry', ['creditor_id', 'debtor_id', 'creation_date', 'transfer_number'], unique=False)
...
def downgrade():
    ...
    op.drop_index('idx_ledger_entry_transfer', table_name='ledger_entry')
    op.drop_index('idx_ledger_entry_entry_id', table_name='ledger_entry')
