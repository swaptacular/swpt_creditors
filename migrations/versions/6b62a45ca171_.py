...
Revision ID: 6b62a45ca171
Revises: 8d8c816257ce
Create Date: 2020-01-27 16:04:29.502866
...
def upgrade():
    ...
    sa.Column('is_effectual', sa.BOOLEAN(), nullable=False),
    sa.Column('ignore_overflow', sa.BOOLEAN(), nullable=False),
