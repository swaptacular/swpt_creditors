...
Revision ID: ecb4af41cdc7
Revises: 8d8c816257ce
Create Date: 2020-07-26 18:19:34.371821
...
def downgrade():
    ...
    op.drop_index('idx_ledger_last_transfer_number', table_name='account_data')
